...
//                b(hpng, "click", function() {
//                        e.fire(g, 3)
//                    }), 
                    j.innerHTML = d.isAndroid ? "GO" : "▶"
                    j.style.color = "#FF0000"
                    j1.innerHTML = d.isAndroid ? "GO" : "▶"
                    j1.style.color = "#FF0000"
                    j2.innerHTML = d.isAndroid ? "GO" : "▶"
                    j2.style.color = "#FF0000"
                    j3.innerHTML = d.isAndroid ? "GO" : "▶"
                    j3.style.color = "#FF0000"
            }
            var h = document.getElementById("button40"),
                h1 = document.getElementById("button30"),
                h2 = document.getElementById("button20"),
                h3 = document.getElementById("button10"),
                hpng = document.getElementById("pinchallenge1"),
                i = document.getElementById("text4"),
                i1 = document.getElementById("text3"),
                i2 = document.getElementById("text2"),
                i3 = document.getElementById("text1"),
                j = document.getElementById("txtAr4"),
                j1 = document.getElementById("txtAr3"),
                j2 = document.getElementById("txtAr2"),
                j3 = document.getElementById("txtAr1"),
                w0 = document.getElementById("title4"),
                w1 = document.getElementById("title3"),
                w2 = document.getElementById("title2"),
                w3 = document.getElementById("title1"),
                k = {
                    show: function() {
                        //a.style.display = ""
                        document.getElementById("contactlist").style.display = ""
                        document.getElementById("pinchallenge").style.display = ""
                        document.getElementById("pinchallenge1").style.display = ""
                        document.getElementById("mapDesc").style.display = ""
                        //document.getElementById("footer").style.display = ""
                        //document.getElementById("game").background: url('./assets/background_2.png');
                        //document.getElementById("pinchallengeFooter").style.display = ""
                    },
                    hide: function() {
                        //a.style.display = "none"
                        document.getElementById("contactlist").style.display = "none"
                        document.getElementById("pinchallenge").style.display = "none"
                        document.getElementById("pinchallenge1").style.display = "none"
                        document.getElementById("mapDesc").style.display = "none"
                        //document.getElementById("footer").style.display = "none"
                        //document.getElementById("game").background: '';
                        //document.getElementById("pinchallengeFooter").style.display = "none"
                    ...
                    level: function(a) {
                        f0 = a,
                            //i.innerHTML = "level " + a
                            i.innerHTML = a
                            i.style.color= "#1CB01A"
                            w0.innerHTML = a
                            var evt = document.createEvent("MouseEvents");
                            evt.initEvent("click",true,true);
                            document.getElementById("levelchange").dispatchEvent(evt);
                    },
                    level1: function(a) {
                        f1 = a,
                            //i1.innerHTML = "level " + a
                            i1.innerHTML = a
                            i1.style.color= "#1CB01A"
                            w1.innerHTML = a
                            var evt = document.createEvent("MouseEvents");
                            evt.initEvent("click",true,true);
                            document.getElementById("levelchange").dispatchEvent(evt);
                    ...
                    level2: function(a) {
                        f2 = a,
                            //i2.innerHTML = "level " + a
                            i2.innerHTML = a
                            i2.style.color= "#1CB01A"
                            w2.innerHTML = a
                            var evt = document.createEvent("MouseEvents");
                            evt.initEvent("click",true,true);
                            document.getElementById("levelchange").dispatchEvent(evt);
                    ...
                    level3: function(a) {
                        f3 = a,
                            //i3.innerHTML = "level " + a
                            i3.innerHTML = a
                            i3.style.color= "#1CB01A"
                            w3.innerHTML = a
                            var evt = document.createEvent("MouseEvents");
                            evt.initEvent("click",true,true);
                            document.getElementById("levelchange").dispatchEvent(evt);
                    ...
                    runstage: function() {
                        //alert(document.getElementById("pinchallenge").title);
                        if(document.getElementById("pinchallenge").title==4) e.fire(g, 0);
                        if(document.getElementById("pinchallenge").title==3) e.fire(g, 1);
                        if(document.getElementById("pinchallenge").title==2) e.fire(g, 2);
                        if(document.getElementById("pinchallenge").title==1) e.fire(g, 3);
                    }
                };
            return c(),
                k
    ...
    //b(h3, "click", function() {e.fire(g, f3) }),
    ...
    $AJB.general.Game = function() {
        ...
        function a() {
            var a = document.body.scrollWidth || document.documentElement.scrollWidth,
                ...
                //alert(a+'+'+b);
                if(a>1024) a=1024,b=b-250;
                r.width = a,
                r.height = b-260,
                i = l(x, a, b-260),
                //document.getElementById("xxx").style.backgroundColor = "#000000",
        ...
        function b0() {
            u.href = B.replace(/#\{level\}/, D0)
        }
        function b1() {
            u.href = B.replace(/#\{level\}/, D1)
        }
        function b2() {
            u.href = B.replace(/#\{level\}/, D2)
        }
        function b3() {
            u.href = B.replace(/#\{level\}/, D3)
        }
        ...
        function d(a) {
            D0 = +a,
                o.setValue(z0, D0),
                document.title = A.replace(/\#\{level\}/, D0),
                GlobalLevel = D0,
                C.level(D0), !p.isWeixin && p.isMobile && b0()
        }
        function d0(a) {
            D0 = +a,
                o.setValue(z0, D0),
        ...
        function d1(a) {
            D1 = +a,
                o.setValue(z1, D1),
                document.title = A.replace(/\#\{level\}/, D1),
                GlobalLevel = D1,
                C.level1(D1), !p.isWeixin && p.isMobile && b1()
        }
        function d2(a) {
            D2 = +a,
                o.setValue(z2, D2),
                document.title = A.replace(/\#\{level\}/, D2),
                GlobalLevel = D2,
                C.level2(D2), !p.isWeixin && p.isMobile && b2()
        }
        function d3(a) {
            D3 = +a,
                o.setValue(z3, D3),
                document.title = A.replace(/\#\{level\}/, D3),
                GlobalLevel = D3,
                C.level3(D3), !p.isWeixin && p.isMobile && b3()
        }
        ...
        function e() {
            n(document.body, "mousedown", function(a) {
                ...
                n(v1, "mousedown", function() {
                    E || (E = !0, t1.style.display = "", d1(1), setTimeout(function() {
                        t1.style.display = "none",
                            E = !1
                    }, 1e3))
                }),
                n(v2, "mousedown", function() {
                    E || (E = !0, t2.style.display = "", d2(1), setTimeout(function() {
                        t2.style.display = "none",
                            E = !1
                    }, 1e3))
                }),
                n(v3, "mousedown", function() {
                    E || (E = !0, t3.style.display = "", d3(1), setTimeout(function() {
                        t3.style.display = "none",
                            E = !1
                    }, 1e3))
                }),
                h.on("passed", function() {
                            if(item==0) d0(D0 + 1);   //write into D0
                            if(item==1) d1(D1 + 1); 
                            if(item==2) d2(D2 + 1); 
                            if(item==3) d3(D3 + 1); 
                            //alert(D0+"+"+D1+"+"+D2+"+"+D3);
                            if(D2==31 || D1==31 || D0==31){                                  //最後一關31
                                ...
                                C.level3(D3),
                                C.show()
                                var evt = document.createEvent("MouseEvents");      //離開畫面通知
                                evt.initEvent("click",true,true);
                                document.getElementById("levelfailed").dispatchEvent(evt)
                            })
                            return;                                
                            }
                            ...
                            i.switchStage(1, function() {
                                if(item==0) h.run(D0);    //Run from D0
                                if(item==1) h.run(D1);
                                if(item==2) h.run(D2);
                                if(item==3) h.run(D3);
                            })    
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            n = $AJB.lib.addEvent(),
            n1 = $AJB.lib.CustEvent(),
            o = $AJB.lib.Storage(),
            p = $AJB.lib.util(),
            q = $AJB.lib.stopEvent(),
            r = document.getElementById("stage"),
            s = document.getElementById("begin"),
            t = document.getElementById("tip4"),
            t1 = document.getElementById("tip3"),
            t2 = document.getElementById("tip2"),
            t3 = document.getElementById("tip1"),
            u = document.getElementById("btnFW"),
            v = document.getElementById("btnReset4"),
            v1 = document.getElementById("btnReset3"),
            v2 = document.getElementById("btnReset2"),
            v3 = document.getElementById("btnReset1"),
            ...
            z2 = "core-ball-level2",
            z3 = "core-ball-level1",
            A = "FOMO見縫插針，第#{level}关了，你也来试试吧!",
            B = "sinaweibo://share?content=FOMO見縫插針，第#{level}关了，你也来试试吧！ http://timelineapp.pointstone.org/coreball/",
            C = m(s),
            D = +o.getValue(z) || 1,
            D0 = +o.getValue(z0) || 1,
            D1 = +o.getValue(z1) || 1,
...
ajax.post('http://timelineapp.pointstone.org/ci/authorize/get_jssdk_info', {
    ...
    wx.ready(function() {
        ...
        wx.onMenuShareAppMessage({
            title: "FOMO見縫插針，第" + GlobalLevel + "关了，你也来试试吧！",
            desc: "FOMO見縫插針，第" + GlobalLevel + "关了，你也来试试吧！",
            link: gameurl,
            imgUrl: imgUrl,
